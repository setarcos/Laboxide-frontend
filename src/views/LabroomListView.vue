<template>
  <div>
    ...
    <div class="mb-4 text-right" v-if="authStore.hasPermission(PERMISSION_ADMIN | PERMISSION_LAB_MANAGER)">
          ...
          <tr v-for="labroom in labrooms" :key="labroom.id">
            ...
            <td>
               <div class="flex gap-1">
                 ...
                 <template v-if="authStore.hasPermission(PERMISSION_ADMIN | PERMISSION_LAB_MANAGER)">
                     <button
    ...
    <!-- Add/Edit Modal -->
     <dialog id="labroom_modal" class="modal" :open="showAddModal || showEditModal">
      <div class="modal-box w-11/12 max-w-lg">
        <h3 class="font-bold text-lg">{{ isEditing ? 'Edit Lab Room' : 'Add New Lab Room' }}</h3>
        <LabroomForm
