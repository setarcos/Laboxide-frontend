<template>
  <div>
    <!-- Teacher Controls -->
    <div
      v-if="isTeacher || authStore.isAdmin"
      class="flex justify-between items-center mb-4 p-4 bg-base-200 rounded-lg"
    >
                ...
                <template v-else-if="isStudent">
                  ...
                  <button
                    ...
                    :class="{
                      loading:
                        isProcessingAction &&
                        processingSubcourseId === subcourse.id,
                    }"
                  >
                    <span
                      v-if="
