<template>
    <div class="h-full menu p-4 w-60 lg:w-80 bg-base-200 text-base-content flex flex-col">
        <!-- Logo or Title -->
        <div class="mb-4 flex items-center gap-2 px-4">
            ...
            <span class="font-bold text-lg">Control Panel</span>
        </div>
        ...
        <ul class="flex-1">
            <li>
             ...
             <!-- Courses visible to Admin, Teacher -->
            <li v-if="authStore.hasPermission(PERMISSION_ADMIN | PERMISSION_TEACHER)">
             ...
             <!-- Labrooms visible to Admin, Lab Manager -->
            ...
            <li v-if="authStore.isAdmin">
             ...
             <!-- Semesters visible only to Admin -->
             <li v-if="authStore.isAdmin">
        ...
        <div class="mt-auto p-2 text-center text-xs text-base-content/60">
            Version 1.0.0
        </div>
    </div>
</template>
...
.menu li > a.active {
    /* DaisyUI usually handles this via linkActiveClass in router, */
