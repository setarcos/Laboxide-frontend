        ...
        <div class="mt-auto flex-shrink-0">
            ...
            <div class="dropdown dropdown-top w-full mb-2"> <!-- Added mb-2 for spacing -->
                <label tabindex="0" role="button" class="btn btn-ghost w-full justify-start capitalize">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-2"><path stroke-linecap="round" stroke-linejoin="round" d="M4.098 19.902a3.75 3.75 0 0 0 5.304 0l6.401-6.402a3.75 3.75 0 0 0-.823-5.55L11.18 5.55a3.75 3.75 0 0 0-5.304 0L1.977 9.451a3.75 3.75 0 0 0-.823 5.55l3.944 3.944Z M19.098 19.902a3.75 3.75 0 1 0-5.304 0l-1.83 1.831a.75.75 0 0 0 1.06 1.061l1.83-1.831Z M16.81 4.09a3.75 3.75 0 0 0-5.304 0L9.675 5.918a.75.75 0 0 0 1.061 1.06l1.83-1.83a3.75 3.75 0 0 0 4.243 0l2.899 2.898a.75.75 0 0 0 1.06-1.06l-2.898-2.898Z" /></svg>
                    Theme: {{ selectedTheme }}
