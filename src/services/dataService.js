...
export const listHistoriesByItem = (itemId) =>
  api.get(`/teacher/equipment/${itemId}/histories`);
export const createEquipmentHistory = (data) =>
...
export const showDiff = () => api.get("/stu/showdiff");
export const copyViHW = () => api.post("/stu/copyvihw");
